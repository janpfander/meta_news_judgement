...
modelsummary::modelsummary(results,
  ...
  # make smaller to fit
  kable_styling(latex_options = "scale_down") %>%
  footnote(general = "Results of separate meta-analyses for different response scales. The effect sizes are not standardized, so that estimates are to be interpreted on their respective scale. One scale, a 100-point scale, does not appear since there was only one effect size using that scale. No adjustments have been made.", threeparttable = TRUE)
