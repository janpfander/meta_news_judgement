...
```{r discernment-countries, fig.cap="(ref:discernment-countries)", fig.height= 6.9}
...
(ref:bias-countries) Response bias estimates by country. 

```{r bias-countries, fig.cap="(ref:bias-countries)", fig.height= 6.9}
...
map <- plot_map(fill = "response bias", data = error_effect)
