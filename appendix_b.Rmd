...
The majority of studies selected false news items from fact checking sites (e.g. Snopes). However, in some studies, researchers verified news themselves. Most notably, @garrettConservativesSusceptibilityPolitical2021 automatically sampled false news items in real-time for a panel study and therefor had to check the veracity of the items themselves. As shown in Tables \@ref(tab:moderators-discernment-table) we find no difference in discernment when comparing news fact checked by fact checking sites compared to news fact checked by researchers. We do find a difference regarding skepticism bias (see Table \@ref(tab:moderators-bias-table)), such that the news items fact checked by researchers show no skepticism bias. As with all between-study moderators, these estimates are likely confounded. The vast majority of effect sizes in the 'verified by researchers' category come from a single paper [@garrettConservativesSusceptibilityPolitical2021]. This paper finds a negative skepticism bias for politically concordant news, suggesting that people are gullible towards information they politically approve. They did not find a skepticism bias for politically discordant items. Political concordance, therefore, is one reasonable candidate of a confounder for the observed difference regarding false news selection.
